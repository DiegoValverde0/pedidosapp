...
namespace PedidosApp
{
    public partial class FrmCategoria : Form
    {
        ...
        private static FrmCategoria _Instancia;
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        int idCategoria = Convert.ToInt32(dataListado.CurrentRow.Cells["idcategoria"].Value);
                        rpta = NCategoria.Editar(idCategoria, txtNombre.Text.Trim().ToUpper(), txtDescripcion.Text.Trim());
                    }
            ...
            try
            {
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow row in dataListado.Rows)
                    {
                        ...
                        {
                            int Codigo = Convert.ToInt32(row.Cells["idcategoria"].Value);
